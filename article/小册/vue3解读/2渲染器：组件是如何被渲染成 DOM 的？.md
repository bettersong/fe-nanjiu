...
![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/187720e9a0aa4c93b52f625ca796880e~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
```js
js
复制代码import { openBlock as _openBlock, createElementBlock as _createElementBlock } from "vue"
...
```js
js
复制代码// packages/runtime-dom/src/index.ts
...
```js
js
复制代码// packages/runtime-core/src/renderer.ts
...
```js
js
复制代码// packages/runtime-core/src/apiCreateApp.ts
...
```typescript
typescript
复制代码// packages/runtime-core/src/vnode.ts
...
```js
js
复制代码render(vnode, rootContainer);
```
...
```js
js
复制代码// packages/runtime-core/src/component.ts
const instance = {
  // 这里是组件对象
  type: vnode.type, 
  // 组件 vnode
...
```js
js
复制代码import { openBlock, createElementBlock } from "vue"
...
```js
js
复制代码if (shapeFlag & ShapeFlags.ELEMENT) {
  processElement(n1, n2, container, anchor, parentComponent);
}
```
...
```js
js
复制代码return (openBlock(), createElementBlock("div", _hoisted_1, [
  hoisted_2,
...
```js
js
复制代码// packages/runtime-dom/src/nodeOps.ts
...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/30a91d25745e496cb0ad763763f40896~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)

然后我们再引用一下 `Vue` 官网上的一张渲染流程图：

![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/05fb0272c6c64b20b77b83012ac99f8c~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)

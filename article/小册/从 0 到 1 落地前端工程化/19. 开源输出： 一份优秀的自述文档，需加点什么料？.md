...
![package.json](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/50037b9fe3b04daa98c3b50fba8886b0~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
`Semver`的出现规定了版本如何表示如何迭代如何比较。遵从`Semver规范`的`Npm模块`，其依赖会很清晰，不会出现循环依赖、依赖冲突等常见问题。关于`Semver`的完整规范可查看[Semver官网](https://link.juejin.cn/?target=https%3A%2F%2Fsemver.org%2Flang%2Fzh-CN)。
...
![版本编号](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7ae960d1363e451b864fae0f070f0fb5~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
当经过先行版本一系列测试后，终归会有一个正式版本，该版本是最终交付到用户使用的一个版本，也就是`release`。例如`react`的[releases](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2Ffacebook%2Freact%2Freleases)。
...
![入口文件](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8ad6b3567fc34c0aa9b6a4833cf813b4~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
开源协议往往需具备专业知识，况且它涉及法律规则，普通人不可能在短时间内就掌握这些知识。`Github`就提供了一系列流行的开源协议满足项目需求，打开[创建仓库](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2Fnew)，点击`License:None`，任君选择。

![创建仓库](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/b66933b7abd14310849a2f79e219ffda~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![许可证书](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8c740ca8eace47e282c8198653909b0e~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
在此贴下[MIT](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2FJowayYoung%2Fbruce%2Fblob%2Fmain%2Flicense)的协议模板，毕竟它是最多项目使用的协议无之一，复制粘贴修改主体信息即可。
...
`Github`中有一个堪称教科书式的`Readme`项目[standard-readme](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2FRichardLitt%2Fstandard-readme)，它为开发者提供一份标准化的编写规范。为了方便编写`Readme`，我将其翻译下，得出一篇完善的`Readme`需由以下部分组成，包括必选与可选。

![Readme](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8567a98289bd46c9ad949bb055b9ca52~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
平时逛`Npm`与`Github`会发现很多仓库的`Readme`都会贴上五颜六色的徽章图标，这些图标美观好看又方便，为清一色的`Readme`加上了点睛之笔。我的开源项目[bruce](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2FJowayYoung%2Fbruce)的[文档站点](https://link.juejin.cn/?target=https%3A%2F%2Fjowayyoung.github.io%2Fbruce)也使用了很多美观好看的徽章图标点缀文档内容。

![Bruce文档](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/eec85a4173a14f28b0f1b5c5d6dbeb98~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)

其实这些徽章图标都是由[Shields](https://link.juejin.cn/?target=https%3A%2F%2Fshields.io)动态生成。`Shields`是一个以`SVG`或光栅格式提供简洁清晰的徽章服务，可轻松地应用在`Readme`或任何网页中。

该服务支持数十种持续集成服务、软件包注册表、发行版、应用商店、社交网络、代码覆盖率服务和代码分析服务，每个月提供超过`7.7亿`张图像。基本上每个受欢迎的开源项目都会使用`Shields`提供的徽章服务。

> 手动生成

打开[Shields](https://link.juejin.cn/?target=https%3A%2F%2Fshields.io)，填写`label标签`与`message消息`，选择 `color颜色`，点击`Make Badge`就会生成一个`URL`，该`URL`其实就是一个动态生成的图像。
...
![BMW 330Li](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/6a694f4fef174d5e97e73965cb8645d4~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
[![Name](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8f661a1570e14046a2b38f75a5d1c3af~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)](https://link.juejin.cn/?target=https%3A%2F%2Fjowayyoung.github.io%2Fbruce) [![Sex](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/f4aade8df2794d44852b2266fc70f9e4~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)](https://link.juejin.cn/?target=https%3A%2F%2Fjowayyoung.github.io%2Fbruce) [![Age](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/62cb1e1c5a494e738f293a202423b964~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)](https://link.juejin.cn/?target=https%3A%2F%2Fjowayyoung.github.io%2Fbruce) [![Area](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7362e21f48e646bba88a99dd32a2360c~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)](https://link.juejin.cn/?target=https%3A%2F%2Fjowayyoung.github.io%2Fbruce)

除了这种常见`URL`生成方式，还可在`URL`后方加上参数实现定制。

> logo与logoWidth

通过`logo`设置左边内容的图标，这些图标可通过[SimpleIcons](https://link.juejin.cn/?target=https%3A%2F%2Fsimpleicons.org)获取。

```md
img.shields.io/badge/@yangzw/bruce--app-1.0.0-f66?logo=npm
```

![@yangzw/bruce-app](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/50403704584f4c0fbce25ecd15e19a0c~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![@yangzw/bruce-app](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c4ace0a06e69420f8cfd9f2791394209~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![@yangzw/bruce-app](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/96cf4f7af1e44126a1e47dd7112e7656~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![@yangzw/bruce-app](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0777bd7c23ee468ba3e65a20e81e4be5~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)

------

另外`Github`也提供类似的徽章服务，若要实时展示自己项目的`Star`、`Fork`和`Watch`，可在`Readme`中加入以下内容。

![Github统计数据](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2c16cae0b0694843a9159bef151bb826~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![自定义统计数据](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2ed35e10683040debdf43528c23f721b~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
因为是实时渲染，相信不少开发者关注[bruce](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2FJowayYoung%2Fbruce)后，每次看都会看到不一样的统计数据。

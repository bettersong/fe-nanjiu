...
![verdaccio](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/859dbfc7191d432a854a928d6d70135e~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
可根据当前需求将`监听端口`与`配置文件`重置。配置文件使用`YAML`语法编写，可查看[YAML教程](https://link.juejin.cn/?target=https%3A%2F%2Fwww.runoob.com%2Fw3cnote%2Fyaml-intro.html)。
...
![verdaccio-yangzw](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1324bd96c4bb44c0966a0ade5cc33a6d~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)

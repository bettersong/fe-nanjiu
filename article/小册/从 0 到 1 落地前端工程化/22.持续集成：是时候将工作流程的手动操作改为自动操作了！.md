...
![GithubToken配置](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/b2cfa62ecf9343b4b89f3a93f1c05588~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)

确定无误后点击`Generate token`，生成一个`Github Token`。

![GithubToken](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c03748cbfedf49529cc38b79eb8127c9~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)

不要刷新网页，立即点击复制按钮把该`token`复制并保存下来，因为刷新网页或重新进入网页，该`token`会消失，只剩下`token名称`。

![GithubToken名称](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ffecf74635bb4bb396614ee7042f5d58~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![ActionsSecret配置](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a4261db9b99c459aa9b09ec819ed1500~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)

确定无误后点击`Add secret`，生成一个`Actions Secret`。

![ActionsSecret](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/6a9b912fe65c47df987995dd50555202~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![GithubPages](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9c2933a7828f42b7b4e5b946ebc88350~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
[ssh-deploy](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2Feasingthemes%2Fssh-deploy)是一个第三方`Actions`，用于自动部署代码到服务器。入参使用`env`配置，可查看[配置列表](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2Feasingthemes%2Fssh-deploy%23configuration)。
...
![CBD](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a4caeaa41d4b4480b63c8a40de6b7c3a~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)

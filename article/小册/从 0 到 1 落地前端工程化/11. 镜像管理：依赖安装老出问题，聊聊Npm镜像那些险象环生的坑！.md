...
而其他`Npm模块`也有类似的代码，例如`puppeteer`安装`Chronium`的[源码部分](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2Fpuppeteer%2Fpuppeteer%2Fblob%2Fmaster%2Finstall.js%23L29)，有兴趣的同学去扒下源码，如出一辙。

...
```js
js
复制代码function patch(n1, n2, container = null, anchor = null, parentComponent = null) {
  // 对于类型不同的新老节点，直接进行卸载
...
```js
js
复制代码export function isSameVNodeType(n1, n2) {
...
```js
js
复制代码const processElement = (n1, n2, container, anchor, parentComponent, parentSuspense, isSVG, optimized) => {
...
```js
js
复制代码const patchElement = (n1, n2, parentComponent, parentSuspense, isSVG, optimized) => {
...
```js
js
复制代码const patchChildren = (n1, n2, container, anchor, parentComponent, parentSuspense, isSVG, optimized = false) => {
  // c1 代表旧节点的子节点元素
...
![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/66213e6cf7cb4e33a7a4a99ec19e7a4b~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
```js
js
复制代码const processComponent = (n1, n2, container, anchor, parentComponent, parentSuspense, isSVG, optimized) => {
  if (n1 == null) {
    // 初始化的过程
  }
  else {
...
```js
js
复制代码const updateComponent = (n1, n2, optimized) => {
...
```js
js
复制代码const updateComponentPreRender = (instance, nextVNode, optimized) => {
...
![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/f0088d60c2054ec9b204f662e55d22cc~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
